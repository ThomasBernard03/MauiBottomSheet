...
public interface IBottomSheetService
{
    ...
    /// <param name="dimDismiss"></param>
    /// <param name="expandable"></param>
    /// <param name="parameters"></param>
    /// <returns>A BottomSheet instance</returns>
    BottomSheet ShowBottomSheet<TView, TViewModel>(bool dimDismiss = true, bool expandable = false, object parameters = null) where TView : View where TViewModel : IBottomSheetRef;
    ...
    /// <returns></returns>
    BottomSheet ShowBottomSheet<TView>(bool dimDismiss = true, bool expandable = false, object parameters = null) where TView : View, IBottomSheetRef;
